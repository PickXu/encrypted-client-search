...
private:
	...
	void traverse_and_addfile(const char *path, Index *index, const char **modifiers);
...
REGISTER_QUERY_CLASS(UpdateQuery, adddir,
	"Adds the contents of the given directory to the index.",
